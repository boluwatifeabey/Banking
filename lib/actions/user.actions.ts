...
export const signUp = async ({ password, ...userData }: SignUpParams) => {
    ...
    try {
        ...
        try {
            ...
            console.error('Creating a Dwolla Customer Failed: ', JSON.stringify(error, null, 2));
            throw error; // To ensure the error is caught in your user.actions.ts file
        }
